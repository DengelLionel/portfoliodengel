...
export default function Habilidades({colortexto}){
    let subtitulo=`relative top-[110px] z-[50] font-bold font-robotob text-center text-xl xl:text-2xl mb-[30px] xl:relative xl:top-[220px] lg:relative lg:top-[110px] 2xl:text-3xl 2xl:top-[230px] ${colortexto}`;
   const dispatch=useDispatch()
    ...
    return(
        ...
        <div className=" h-[170vh] sm:h-[135vh] md:h-[120vh] lg:h-[120vh] xl:h-[160vh] 2xl:h-[130vh]  ">
             <h2 id="habilidad" className={subtitulo}>SKILLS</h2>
        <div className=" w-full h-[100px] mt-[70px] mb-[70px] xl:mt-[180px] flex justify-center items-center ">
