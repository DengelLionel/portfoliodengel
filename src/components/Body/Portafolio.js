...
export default function Portafolio({colortexto}){
    ...
    return(
        ...
        <section  className=" h-[125vh] sm:h-[130vh] md:h-[135vh] lg:h-[155vh] xl:h-[140vh]   2xl:h-[190vh] z-[25]  ">
        ...
        <section className="w-full h-[500px] mt-[50px] overflow-y-scroll xl:overflow-x-hidden  pt-[20px] pb-[20px] grid grid-cols-[auto] gap-4 justify-center items-center lg:grid lg:grid-cols-[auto] lg:gap-10   lg:h-[610px]  xl:w-full xl:grid xl:grid-cols-[auto]  xl:gap-[60px]  relative -top-[15vh] sm:relative sm:-top-[10vh] 2xl:mt-[50px]">
