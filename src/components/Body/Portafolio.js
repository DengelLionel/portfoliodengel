...
export default function Portafolio({colortexto}){
    ...
    },[colortexto,claseTitulo,getColorCategoriaProyecto,getColorCategoriaProyectoHover])
    
    const ClaseBottom1=`${getColorCategoriaProyectoHover&&getColorCategoriaProyectoHover} ${webDevelopment===true?getColorCategoriaProyectoActivo:getColorCategoriaProyecto}  font-medium text-md  p-2 rounded-bl-xl rounded-br-xl rounded-tl-xl rounded-tr-xl  font-robotom lg:text-lg xl:text-xl xl:rounded-bl-2xl xl:rounded-tr-2xl xl:rounded-br-2xl xl:rounded-tl-2xl 2xl:text-2xl 2xl:rounded-tl-3xl 2xl:rounded-br-3xl  2xl:rounded-tr-3xl 2xl:rounded-bl-3xl`;
    const ClaseBottom2=`${getColorCategoriaProyectoHover&&getColorCategoriaProyectoHover} ${movilDevelopment===true?getColorCategoriaProyectoActivo:getColorCategoriaProyecto} font-medium text-md  p-2 rounded-bl-xl rounded-br-xl rounded-tl-xl rounded-tr-xl  font-robotom lg:text-lg xl:text-xl xl:rounded-bl-2xl xl:rounded-tr-2xl xl:rounded-br-2xl xl:rounded-tl-2xl 2xl:text-2xl 2xl:rounded-tl-3xl 2xl:rounded-br-3xl  2xl:rounded-tr-3xl 2xl:rounded-bl-3xl`;
    const ClaseBottom3=`${getColorCategoriaProyectoHover} ${design===true?getColorCategoriaProyectoActivo:getColorCategoriaProyecto} font-medium text-md  p-2 rounded-bl-xl rounded-br-xl rounded-tl-xl rounded-tr-xl font-robotom lg:text-lg xl:text-xl xl:rounded-bl-2xl xl:rounded-tr-2xl xl:rounded-br-2xl xl:rounded-tl-2xl 2xl:text-2xl 2xl:rounded-tl-3xl 2xl:rounded-br-3xl  2xl:rounded-tr-3xl 2xl:rounded-bl-3xl`;
    return(
        <> 
