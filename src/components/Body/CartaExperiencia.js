    ...
    return(
        ...
        <div class="w-[200px] p-[12px] lg:w-[300px] lg:h-[300px]  bg-gray-400 rounded-xl xl:w-[300px] xl:h-[300px] xl:pl-[5px] 2xl:w-[350px] 2xl:h-[350px]">
            ...
            <div className=" flex flex-row justify-center xl:h-[150px] items-center gap-2">
                ...
                </div>):(<div className="bg-blue-600 w-[70px] h-[70px] flex flex-row justify-center items-center rounded-full hover:bg-blue-900 hover:shadow-sm xl:shadow-xl cursor-pointer">
                ...
                {paginaHithub===""?(<div className="bg-green-400 hover:text-blue-700 hover:bg-white hover:shadow-sm xl:hover:shadow-xl w-[70px] h-[70px] flex flex-row justify-center items-center rounded-full cursor-no-drop">
               ...
               </div>):(<div className="bg-green-400 hover:text-blue-700 hover:bg-white hover:shadow-sm xl:hover:shadow-xl w-[70px] h-[70px] flex flex-row justify-center items-center rounded-full cursor-pointer">
