...
export default function Projects({colortexto,titleProject,categoryWebdev,categoryMobiledev}){
    ...
    return(
        ...
        <h2 id="portafolio" className={`duration-1000 transition-all relative top-[85px] z-[50] font-bold font-robotob text-center text-[2.25rem] xl:text-[3.75rem] mb-[30px] xl:relative xl:top-[90px] 2xl:text-[3.75rem] 2xl:relative 2xl:top-[165px] ${colortexto}`}>{titleProject}</h2>
            ...
            <section className=" lg:grid lg:grid-cols-[auto] lg:w-full lg:h-[80vh] xl:grid xl:grid-cols-[auto] xl:mt-[200px] xl:items-center xl:w-[100%]  md:mt-[50px]">
                ...
                <div className="relative -top-[80px] w-full h-[65px] pl-2 pr-2  grid grid-cols-[auto,auto] gap-2 mb-[20px] xl:grid xl:grid-cols-[auto,auto] xl:pl-[20px] xl:pr-[20px]">
                <button onClick={HandledWebDevelopment} className={`${getColorCategoriaProyectoHover&&getColorCategoriaProyectoHover} ${webDevelopment===true?getColorCategoriaProyectoActivo:getColorCategoriaProyecto}  font-medium text-md  p-2 rounded-bl-xl rounded-br-xl rounded-tl-xl rounded-tr-xl  font-robotom lg:text-lg xl:text-xl xl:rounded-bl-2xl xl:rounded-tr-2xl xl:rounded-br-2xl xl:rounded-tl-2xl 2xl:text-2xl 2xl:rounded-tl-3xl 2xl:rounded-br-3xl  2xl:rounded-tr-3xl 2xl:rounded-bl-3xl duration-1000 transition-all`}>{categoryWebdev}</button >
                <button onClick={HandleMovilDevelopment} className={`${getColorCategoriaProyectoHover&&getColorCategoriaProyectoHover} ${movilDevelopment===true?getColorCategoriaProyectoActivo:getColorCategoriaProyecto} font-medium text-md  p-2 rounded-bl-xl rounded-br-xl rounded-tl-xl rounded-tr-xl  font-robotom lg:text-lg xl:text-xl xl:rounded-bl-2xl xl:rounded-tr-2xl xl:rounded-br-2xl xl:rounded-tl-2xl 2xl:text-2xl 2xl:rounded-tl-3xl 2xl:rounded-br-3xl  2xl:rounded-tr-3xl 2xl:rounded-bl-3xl duration-1000 transition-all`}>{categoryMobiledev}</button>
