...
export default function SeccionBienvenido(){
        ...
        const colorContenedor=`${getColor} w-full h-[670px] z-[50] p-4  lg:h-[640px]  2xl:h-[800px] xl:rounded-bl-[130px] xl:rounded-br-[130px] rounded-bl-[50px]  md:h-[500px]  md:relative md:top-[40px] sm:rounded-br-[100%] sm:rounded-bl-[0px] sm:h-[500px]  sm:z-[70] sm:relative sm:-top-[80px]  `
        useEffect(()=>{
            ...
            <section className=" xl:flex xl:justify-center xl:items-center  lg:flex lg:flex-col lg:justify-center lg:items-center" >
               ...
               <div className=" font-normal text-md lg:text-xl xl:text-2xl 2xl:text-3xl xl:p-2  font-robotor grid grid-rows-[auto,auto,auto]   xl:grid xl:grid-rows-[auto,auto,auto] ">
                ...
                <section className="w-full flex justify-center items-center">
                    <div className="hidden w-[160px] h-[160px] lg:w-[300px] lg:h-[300px] xl:w-[320px] xl:h-[320px] 2xl:w-[360px] 2xl:h-[360px] rounded-full bg-degradadoperfil sm:flex justify-center items-center sm:relative sm:-top-[30px] ">
