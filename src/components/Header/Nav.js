 ...
 function Nav({openState}){
    ...
    return(
        ...
        valorScroll={valorScroll} openState={valorF} fondoNav={colorStyled}>
               ...
               <Link to="/" className="pb-[20px] text-white font-ronsard font-bold cursor-pointer xl:p-[15px] border-2  border-transparent hover:text-black   xl:hover:border-t-transparent xl:hover:border-l-transparent xl:hover:border-r-transparent xl:hover:border-white xl:hover:text-black xl:before:shadow-xl  sm:p-[5px] sm:text-sm lg:p-[20px] 2xl:text-2xl leading-relaxed tracking-widest xl:text-xl" onClick={()=>{scrollToAnchorI();CategoriaValor()}}>HOME</Link>
                <a className="font-ronsard  font-bold pb-[20px] text-white cursor-pointer xl:p-[15px] border-2 border-transparent hover:text-black xl:hover:bg-transparent xl:hover:border-t-transparent xl:hover:border-l-transparent xl:hover:border-r-transparent xl:hidden xl:hover:border-white xl:hover:text-black  xl:before:shadow-xl  sm:p-[5px] sm:text-sm lg:p-[8px] 2xl:text-2xl  leading-relaxed tracking-widest sm:hidden" onClick={()=>{scrollToAnchorP();CategoriaValor()}}>PROJECTS</a>
                <a className="font-ronsard font-bold pb-[20px] text-white cursor-pointer xl:p-[15px] border-2 border-transparent hover:text-black  xl:hover:bg-transparent xl:hover:border-t-transparent xl:hover:border-l-transparent xl:hover:border-r-transparent xl:hover:border-white xl:hover:text-black xl:hover:before:shadow-xl sm:p-[5px] sm:text-sm lg:p-[8px] 2xl:text-2xl  leading-relaxed tracking-widest xl:text-xl" onClick={()=>{scrollToAnchorH();CategoriaValor()}} > SKILLS</a>
                <a className="font-ronsard font-bold pb-[20px] text-white cursor-pointer xl:p-[15px] border-2 border-transparent hover:text-black xl:hover:bg-transparent xl:hover:border-t-transparent xl:hover:border-l-transparent xl:hover:border-r-transparent xl:hover:border-white xl:hover:text-black xl:before:hover:shadow-xl sm:p-[5px] sm:text-sm lg:p-[8px] 2xl:text-2xl  leading-relaxed tracking-widest xl:text-xl" onClick={()=>{scrollToAnchorE();CategoriaValor()}}>EXPERIENCES</a>
