...
export default function ImagePresentation({titleMain}){
  useEffect(()=>{
    ...
    return(
        <header id="inicio"  className='h-[200px] sm:h-[150px] lg:h-[190px] xl:h-[200px] xl:w-full 2xl:h-[200px]'>
            ...
            <h4  className="font-bold text-center font-robotob tracking-wide text-yellow-500 bg-degradadonegro w-full h-[30px] lg:text-xl xl:text-2xl 2xl:text-2xl">{titleMain}</h4>
            </div>
            </section>
            </div>
            </div>
